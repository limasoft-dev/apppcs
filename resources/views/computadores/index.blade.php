        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex flex-row">
                    <a href="{{route('computadores.create')}}" class="btn btn-primary btn-lg">Criar novo</a>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <tbody>
                        @forelse ($computadores as $computador)
                            <tr>
                                ...
                                <td>{{$computador->serialnr}}</td>
                                <td>{{$computador->modelo->modelo}}</td>
                                <td>{{$computador->cliente->cliente}}</td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td scope="row" colspan=4>Ainda sem computadores</td>
                            </tr>
                        @endforelse
                    </tbody>
                  </table>
